        ...
        {fields.map((field, index) => (
          ...
          >
            <input
              ...
              className={`${(errors?.taskStatus?.[index] || errors?.subtasks?.[index]) ? 'border-red-600' : 'border-gray-200 dark:border-gray-500'} dark:bg-slate-800 border-2 rounded-md py-2 px-2 text-black dark:text-white text-sm w-full appearance-none font-normal`}
              {...register(
