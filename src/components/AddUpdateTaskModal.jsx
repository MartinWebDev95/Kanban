        ...
        >
          ...
          <label htmlFor="taskName" className="flex flex-col gap-2">
            ...
            <input
              ...
              className={`${errors.taskName ? 'border-red-600' : 'border-gray-200 dark:border-gray-500'} dark:bg-slate-800 border-2 rounded-md py-2 px-2 text-black dark:text-white text-sm placeholder:text-sm appearance-none font-normal`}
              {...register(
                'taskName',
                {
          ...
          <label htmlFor="description" className="flex flex-col gap-2">
            ...
            <textarea
              ...
              className={`${errors.taskDescription ? 'border-red-600' : 'border-gray-200 dark:border-gray-500'} dark:bg-slate-800 border-2 rounded-md py-2 px-2 text-black dark:text-white text-sm placeholder:text-sm appearance-none font-normal`}
              {...register(
                'taskDescription',
                { pattern: /^[a-zA-Z0-9\-\_\,\;\.\'ÑñáéíóúÁÉÍÓÚ\s]{3,}$/ },
              )}
